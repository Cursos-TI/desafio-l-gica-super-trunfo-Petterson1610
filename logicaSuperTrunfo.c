...
//NESTE EXEMPLO O VALOR DA VARIAVEIS FORAM DEFINIDOS COM O INTUITO DE TESTAR A LÓGICA DO PROGRAMA. PARA FICAR COMPLETAR É PRECISO DESCOMENTAR DA LINHA 57 ATE A 132 E COMENTAR DA LINHA 28 ATÉ A 49.

//A VARIAVEL SUPER_PODER FOI COMENTADA POIS NÃO ESTÁ SENDO UTILIZADA NO PROGRAMA
...
int main() {
    ...
    estado2 = 'B';
    strcpy(codigo_da_carta2, "B01");
    strcpy(nome_da_cidade2, "Rio de Janeiro");
    qtde_pontos_turisticos2 = 70;
    populacao2 = 500470;
    area2 = 2000.11;
    pib2 = 366.9;
